...
Public Class renlic
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        cmd1 = New OleDbCommand("insert into Permanent values('" & TextBox8.Text & "','" & TextBox3.Text & "','" & DateTimePicker1.Value.AddMonths(120) & "','" & TextBox2.Text & "','" & DateTimePicker1.Value.AddMonths(1 / 4) & ")", con)
