...
Partial Public Class DBDataSet
    ...
    Partial Public Class loginDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddloginRow(ByVal uname As String, ByVal pass As String) As loginRow
            Dim rowloginRow As loginRow = CType(Me.NewRow,loginRow)
            Dim columnValuesArray() As Object = New Object() {uname, pass}
...
Namespace DBDataSetTableAdapters
    ...
    Partial Public Class loginTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `login` WHERE ((`uname` = ?) AND ((? = 1 AND `pass` IS NULL) OR (`pas"& _ 
                "s` = ?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `login` (`uname`, `pass`) VALUES (?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `login` SET `uname` = ?, `pass` = ? WHERE ((`uname` = ?) AND ((? = 1 AND `"& _ 
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT uname, pass FROM login"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_uname As String, ByVal Original_pass As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal uname As String, ByVal pass As String, ByVal Original_uname As String, ByVal Original_pass As String) As Integer
            If (uname Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal pass As String, ByVal Original_uname As String, ByVal Original_pass As String) As Integer
            Return Me.Update(Original_uname, pass, Original_uname, Original_pass)
        End Function
    End Class
