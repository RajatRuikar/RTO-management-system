...
Public Class govreg
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        cmd = New OleDbCommand("insert into Vehicle values('" & TextBox1.Text & "','" & TextBox3.Text & "','" & TextBox2.Text & "','" & TextBox6.Text & "','" & TextBox5.Text & "','" & ComboBox1.SelectedItem & "','" & ComboBox2.SelectedItem & "','" & TextBox10.Text & "','" & TextBox8.Text & "','" & TextBox4.Text & "','" & TextBox9.Text & "','" & B & "','" & T & "' )", con)
        Dim y As Integer
